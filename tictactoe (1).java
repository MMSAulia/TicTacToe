...
public class TicTacToe
{
    ...
    public static void main(String args[])
    {
        ...
        do{
            Toe.newBoard();
            Toe.play();
            System.out.println (" Main Lagi (Ketik 'yes')? ");
            Scanner in =new Scanner(System.in);
            ch=in.nextLine();
            System.out.println("ch adalah  "+ch);
        }while (ch.equals("yes"));
    ...
    public  void play()
    {
        ...
        System.out.println(  "Pemain " + getPlayer() +"X" );
        
        do {
            currentBoard();              // display current board
            
            System.out.println(  "\n\n Pemain " + getPlayer() +" pilih posn." );
            ...
            System.out.println(  "langkah yang bagus." );
    ...
    public  char checkWinner()
    {
        ...
        for(int i=1;i<10;i++)
        {
            if(posn[i]=='X' || posn[i]=='O')
            {
                ...
                {
                    char Draw='D';
                    System.out.println(" Langkah Buntu ");
                    return Draw;
                }
                continue;
            }
    ...
    public  boolean checkPosn(int spot)
    {
        ...
        {
            System.out.println("Posisi itu sudah diambil, silakan pilih yang lain");
            return true;
        }
        else {
            return false;
